...
class GLTFParser {
	...
	constructor( json = {}, options = {} ) {
		...
		if ( typeof three.PlatformManager.polyfill.createImageBitmap !== 'undefined' && /Firefox/.test( three.PlatformManager.polyfill.navigator.userAgent ) === false ) {
	...
	loadTextureImage( textureIndex, source, loader ) {
		...
		if ( source.bufferView !== undefined ) {
			...
			sourceURI = parser.getDependency( 'bufferView', source.bufferView ).then( function ( bufferView ) {
				...
				isObjectURL = true;
				const blob = new three.PlatformManager.polyfill.Blob( [ bufferView ], { type: source.mimeType } );
...
function screenshot(renderer, scene, camera, WebGLRenderTarget) {
    var _domElement = renderer.domElement, width = _domElement.width, height = _domElement.height;
